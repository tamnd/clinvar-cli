...
// HTTP behaviour is covered in clinvar_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "clinvar://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("clinvar", "about")
	if err != nil || got.String() != "clinvar://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want clinvar://page/about", got.String(), err)
	}
}
