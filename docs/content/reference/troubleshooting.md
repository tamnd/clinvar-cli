...
Most of these come down to network reality or how clinvar serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

clinvar rate-limits like any public site. clinvar already paces
...
Where a surface is gated, clinvar reads a cookie or token you supply
...
`clinvar`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what clinvar actually did
